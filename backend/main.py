...
app = FastAPI(title="CloudHub HR Portal API", version="1.0.0")
...
@app.get("/api")
def root(): return {"message": "CloudHub HR Portal API", "status": "running"}
@app.get("/health")
...
def serve_ui():
    ...
    return {"message": "CloudHub HR Portal API", "status": "running", "docs": "/docs"}
